        ...
        <div className="matches-section">
          ...
          <div className="column">
            ...
            {completedMatches.map((match, index) => (
              <div key={index} className="result-item">
                ...
                <h1 className="teams-name">{match.teams}</h1>
              </div>
            ))}
          </div>
          ...
          <div className="column next-match-column">
            ...
            <div className="countdown-timer">
              <p>{timeLeft.days} <span>Days</span> {timeLeft.hours} <span>Hours</span> {timeLeft.minutes} <span>Minutes</span> {timeLeft.seconds} <span>Seconds</span></p>
            </div>
